<?php 
$page_title = 'Register | Ubuntu Haven Resort';
$hero_image = '/UBUNTU-HAVEN/img/image.webp';
include '../includes/header.php'; 
?>
        <div class="hero__content">
          <h1 class="hero__title">Join the Community</h1>
        </div>
      </header>
      ...
      <main id="main-content" class="section">
        <div class="container" style="max-width: 500px; margin: 0 auto; text-align: center;">
            ...
            <form action="process_register.php" method="POST" style="display: flex; flex-direction: column; gap: 16px;">
                ...
                <input type="password" name="password" placeholder="Create Password" required style="padding: 12px; border: 1px solid #ccc; border-radius: 4px; font-family: var(--font-family-body);">
                <button type="submit" class="button-outline" style="background-color: var(--primary-01); color: white; justify-content: center;">Register</button>
            </form>
            <p style="margin-top: 16px;">Already have an account? <a href="login.php" style="color: var(--primary-02);">Sign in</a></p>
        </div>
      </main>
